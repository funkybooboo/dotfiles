...
# Installs (pacman): earlyoom fwupd yazi man-db less
# Installs (AUR):    zram-generator
# Links:    --
...
if is_debian; then
  ...
  install_gh_release sxyazi/yazi 'x86_64-unknown-linux-gnu' yazi || \
    _add_warning "yazi: install manually on Debian (https://github.com/sxyazi/yazi/releases)"
else
  install_pacman earlyoom fwupd yazi man-db less
