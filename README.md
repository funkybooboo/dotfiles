...
76 migrations grouped by concern. `ls migrations/` for the full list.
...
| `000500`–`000550` | Apps: VPN, Tailscale, Proton Pass, NAS sync, games, lazycsv, Ollama, caligula, Minecraft launcher, AUR-debug cleanup |
